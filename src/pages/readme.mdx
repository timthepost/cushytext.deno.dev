...
See `/pages` for inner page example, `/docs` for documentation (not for this 
theme,  at least not yet, just as an example for generated docs) and `/posts` 
for the blog styles. I don't have indexes worked out yet. Or tags.
