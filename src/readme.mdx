...
<strong>
[Get this sloppy MDX code on Github &raquo;](https://github.com/timthepost/lume-infima)
</strong> 

This is a copy of the `README.md` file from the repo:
...
I'm [Tim Post](https://timthepost.netlify.app) (`timthepost@protonmail.com`) if you want to collaborate, you can also find me
