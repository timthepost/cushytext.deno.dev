...
metas:
  ...
  image: /blog/announcing-cushy-text/index.png
  robots: true
  generator: true
---
...
folders, independent navigation and even independent tags and authors if you want.
...
```html
  <ul class="menu__list">
    {{ for entry of search.pages('waypoint=%blog% menu.visible=true', "date=desc", 3) }}
