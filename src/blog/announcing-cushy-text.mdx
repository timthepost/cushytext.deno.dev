...
blog instances with independent archives, build content and landing pages and have 
interactive features that take advantage of Deno & Deno Deploy ready to use.
...
The theme allows you to run multiple blogs independent tags, archive pages, author 
pages, feeds and even designs all on the same URL. I wanted to be able to have a 
very basic status blog, release notes blog, and main blog, as an example.
