...
It would be much more work to maintain features that would be less convenient to 
use in order to maintain a theme that worked everywhere, so the decision was made
to take full advantage of running on Deno Deploy and deliver a great experience 
there, rather than an underwhelming experience everywhere that requires lots of 
configuration.  
