...
# Goals:
 ...
 - Be component driven (all [features](/features/) should be Lume 3 components with
   isolated CSS), this includes the hero banner above this content.

 - Be i18n friendly, but don't go overboard. See also "Don't try to be Docusaurus" 
   below.
