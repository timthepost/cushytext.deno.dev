...
is set, which is also used by CushyDocs to control dev mode. I named mine `src/admin.mdx`
because I find `http://localhost:3000/admin/` the most convenient. You do you, here's
the sparse code you'll need:
