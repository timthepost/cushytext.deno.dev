...
In my case, I often want a mini-blog with a feed just for release notes, with 
a conversational blog designed very differently. Or maybe you want an easy 
"app status" mechanism.

<span class="text--danger">
  <strong>
  I do not encourage multiple independent archive & tag page areas being generated. 
  </strong>
</span>

While you _could_ modify the archive generators to take the archetype 
data into consideration and adjust their yield location, I _strongly_
advise not doing that. Grab the tags and authors from the areas that 
you want, and display them centrally.

These pages have very little content or informational value, they seldom
get indexed anyway, and they could (if you had a lot of them) get you
penalized under scrutiny of algorithms. I understand that there are 
perfectly valid use cases for doing this, but it's up to you to implement
