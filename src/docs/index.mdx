...
The theme won't officially release until a short time after Lume 3 releases, 
...
plugin. Just understand there are still a constant stream of tweaks coming in 
and probably will be until release day. See the docs in the README there, or 
[the plugin docs and examples here](/docs/theme-plugins/#simple-seo).

<h2 id="roadmap">Near-Term Roadmap: (`0.0.5 - 0.1.0`)</h2>
