...
description: "Status & Quickstart: Cushy Text"
menu:
  visible: true
  order: 0
metas:
  description: A primer on how to get started with the CushyText Lume Theme, Under Development.
...
and let me know which one. Note that I left Source Maps out as I consider 
that a dev one to use locally. 
