...
## Status Of Pre-Configured Plugins:
...
| picture | Create Responsive Images Automatically | base | Lume Official | Yes | Yes` |
| basepath   | Core Lume Plugin       | base | Lume Official | Yes | Yes |
| nav        | Nav helper for Lume    | base | Lume Official | Yes | N/A |
| transform-images | Transform Images | base | Lume Official | Yes | Yes` |
| mdx        | Default Document, Built On SSX | base | Lume Official | Yes | N/A |
| postcss    | CSS Processor          | css | Lume Official | Yes | Yes` |
