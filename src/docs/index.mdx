...
around this, I put the Pagefind search div in a modal that opens when the navigation 
bar search gets focus. Similar to how Algolia works.

This works well enough to ship, however: and this is a ***big*** however:
