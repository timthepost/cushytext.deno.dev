...
Things are pretty stable, it's time to cut a release people can update from. 
...
but understand that development is moving to an entirely new repository on release, and this 
will soon just host the theme's site and blog. In short the theme gets its own repo, and this
site becomes a user of it, just like everyone else. I won't be hosting a live site out of
the same repo I distribute the theme and plugins from.
