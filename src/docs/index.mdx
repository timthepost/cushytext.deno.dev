...
The blog and docs archetypes need working prev/next links, breadcrumbs 
and (for blog) pagination. That's the last "shared" feature between the
two.

Once that's done, docs needs a way to load a custom sidebar, and it will
be feature complete.
